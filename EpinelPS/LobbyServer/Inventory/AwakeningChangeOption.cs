    ...
    public class AwakeningChangeOption : LobbyMsgHandler
    {
        protected override async Task HandleAsync()
        {
            ...
            if (req.IsChanged)
            {
                ...
                reset.IsOption1DisposableLock = false;
                reset.IsOption2DisposableLock = false;
                reset.IsOption3DisposableLock = false;
                AwakeningOption option = new()
                {
                    ...
                    IsOption1DisposableLock = reset.IsOption1DisposableLock,
                    IsOption2DisposableLock = reset.IsOption2DisposableLock,
                    IsOption3DisposableLock = reset.IsOption3DisposableLock
                };
